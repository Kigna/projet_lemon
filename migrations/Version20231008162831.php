 ...
 */
final class Version20231008162831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenements (id INT AUTO_INCREMENT NOT NULL, id_createur_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, INDEX IDX_E10AD4006BB0CC12 (id_createur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE evenements ADD CONSTRAINT FK_E10AD4006BB0CC12 FOREIGN KEY (id_createur_id) REFERENCES utilisateurs (id)');
